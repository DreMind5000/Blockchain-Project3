...
import Logo2 from "../public/images/fav.png";
              ...
              <div className="flex justify-between h-16">
                <div className="flex">
                  ...
                  <div className="flex-shrink-0 flex items-center">
                    <div className="pt-2 lg:block md:hidden hidden ">
                      <Image src={Logo} width={350} height={75} />
                    </div>
                    <div className="pt-2 lg:hidden md:block sm:block">
                      <div>
                        <Image src={Logo2} width={80} height={75} />
                      </div>
                    </div>
                      ...
                      <Link key={item.name} href={item.href}>
                        <p
                          className={classNames(
                            ...
                            "px-3 py-2 rounded-md text-sm font-semibold	 text-black cursor-pointer "
                          )}
                        >
                          {item.name}
                        </p>
                    ...
                    <p
                      className={classNames(
                        item.current
                          ...
                          : "text-black hover:bg-gray-700 hover:text-white",
                        " text-black  px-3 py-2 rounded-md text-base font-medium cursor-pointer"
                      )}
                    >
                      {item.name}
                    </p>
            ...
            <div className="grid grid-cols-2 gap-8 xl:col-span-4">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-semibold text-indigo-700 tracking-wider uppercase">
                    Useful Links
                  </h3>
                  <ul role="list" className="mt-4 space-y-2">
                    {navigation.map((item) => (
